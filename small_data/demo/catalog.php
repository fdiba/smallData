<?php
	...
	if($id==1){
		$coll_desc  = "This page shows the <strong>International Sound Archives</strong>, the IMEB's <em>Phonoth&egrave;que A</em>, said &laquo;&nbsp;Ext&eacute;rieure&nbsp;&raquo;: electroacoustic works by outside composers, gathered by the IMEB under catalogue index 100&thinsp;000.";
		$cov_note   = "<strong>Coverage.</strong> The <em>edition(s)</em> column is knowingly incomplete. The <em>R&eacute;pertoire g&eacute;n&eacute;ral</em> records a programming year for about half of the 5&thinsp;828 works in this collection, and the cell is left empty for the other half. An empty cell means the repertoire holds no record of a performance, not that the work was never played. Around a thousand works here are by composers who appear at no edition in our participation index either. That index is drawn from the competition minutes, which have been fully entered only for 1973 to 1994 and are still partially processed from 1996 to 2009, so their absence is a gap in what has been read, not a statement about what happened. No competition was held in 1995, so no work carries that year.";
	} else {
		$coll_desc  = "This page shows the <strong>IMEB Sound Archives</strong>, the IMEB's <em>Phonoth&egrave;que B</em>: works produced in the institute's own studios, under catalogue index 200&thinsp;000.";
		$cov_note   = "<strong>Coverage.</strong> The <em>edition(s)</em> column is knowingly incomplete: a programming year is recorded for roughly one work in four of this collection's 765 works. These works were produced in the institute's own studios, and an entry in the archive does not imply a festival performance. An empty cell means the repertoire holds no record of one. No competition was held in 1995, so no work carries that year.";
	}
...
<?php if($id==1 || $id==2){ ?>
			<div id="legend" class="is-collapsed">
				...
				<div class="lg-cols">
					<div>
						<p class="lg-intro">The IMEB's holdings form the <em>Fonds MISAME</em>. Its <em>R&eacute;pertoire g&eacute;n&eacute;ral</em>, compiled by Christian Clozier, brings together 1&thinsp;946 composers, 6&thinsp;612 works and 63 countries, split into two phonoth&egrave;ques: the <em>International Sound Archives</em> (Phonoth&egrave;que A, &laquo;&nbsp;Ext&eacute;rieure&nbsp;&raquo;) and the <em>IMEB Sound Archives</em> (Phonoth&egrave;que B). <?php echo $coll_desc ?></p>
