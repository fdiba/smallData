			...
			<div class="lg-cols">
				<div>
					...
					<ul>
						...
						<li><span class="sq" style="background:#2ecc71"></span> <em>transcribed in full from the bailiff's record</em> &mdash; every entry is attested (1973&ndash;1992)</li>
						<li><span class="sq" style="background:#e67e22"></span> <em>minutes transcribed</em>, but not from the bailiff's record &mdash; the count is entered, not attested (1993&ndash;1994)</li>
				...
				<div>
					...
					<ul>
						...
						<li><em>only those with a work</em> &mdash; the same people, minus those the database knows by a candidacy alone. This is the measure of the <em>collection</em>, and it is a good deal smaller: of the <em>4&nbsp;276</em> people the database records as entrants, <em>2&nbsp;787</em> have no archived work at all &mdash; nearly two in three, and the share grows with every edition transcribed, because a bailiff&rsquo;s record names entrants, not works</li>
