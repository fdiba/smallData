...
.baseline, .caption{ text-align:left; }
a{ color:#fff; }
...
@media (max-width:600px){
	...
	p, .rubriques span{ text-align:left; }
}
</style>
</head>
<body>
...
?>
	...
	<ul class="rubriques">
		...
		<li>
			...
			<span>How many people entered, by country and by edition. Three charts read the same figures: a matrix of countries by editions, a line chart, and a bar chart for a single edition. A switch chooses whether to count every entrant or only those whose work is in the collection.</span>
		</li>
		<li>
